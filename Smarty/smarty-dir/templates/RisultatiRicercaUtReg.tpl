        ...
        <div class="col-md-12">
          <ul class="nav pull-right" style="">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link text-white" href="#" role="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown">AProfilo <i class="fa fa-user-o fa-fw" aria-hidden="true"></i></a>
