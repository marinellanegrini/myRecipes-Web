    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-md-12 mx-auto">
          ...
          <form action="/myRecipes/web/" align="left" enctype="multipart/form-data" class="ml-3 pt-3">
            ...
            <br>
            <br>
            <button type="submit" style="" class="btn btn-primary btn-lg mr-2 mt-2" onclick=""><b>Installa</b></button>
          </form>
        </div>
      </div>
    </div>
