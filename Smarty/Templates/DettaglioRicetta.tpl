...
<body class="bg-light" style="">
  ...
  <div class="py-4">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="display-4 text-dark">Nome Ricetta</h1>
        </div>
      </div>
    </div>
  </div>
  <div class="">
    <div class="container">
      <div class="row">
        <div class="col-md-8"><img class="img-fluid d-block w-100 h-50" src="../fast_food.jpg_1267619266.jpg" style=""></div>
        <div class="col-md-4">
    ...
    <div class="container">
      <div class="row">
        <div class="p-4 col-lg-12 text-dark">
          <h4 class="mb-3 text-dark"><b>Ingredienti</b></h4>
          <ul class="">
  ...
  <script src="https://cdnjs.cloudflare.comajax/libs/popper.js/1.14.3/umd/popper.min.js" integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous" style=""></script>
