...
<body style="">
  ...
  <form action="/action_page.php" align="left" enctype="multipart/form-data" class="ml-3 pt-3" style=""> Nome ricetta:<br>
    ...
    <input type="file" name="immprincipale" class="ml-5 py-2"><br>
    ...
    <button type="submit" class="btn btn-primary btn-lg mr-2 mt-2 pull-right" style=" position: absolute; right:100; bottom:"><b>Inserisci ricetta</b></button>
  </form>
  <!-- Optional JavaScript -->
