...
<body class="bg-light" style="">
  <nav class="navbar navbar-expand-md bg-primary">
    <div class="container">
      <div class="row">
        <div class="col-md-10" style=""><img class="img-fluid d-block w-75" src="foto usate/logobiancopieno.png"></div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center mx-auto col-lg-12 col-10">
          <h1 class="mb-3 text-dark">Account</h1>
  ...
  <div class="">
    <div class="container">
      <div class="row">
        <div class="col-md-6"><img class="img-fluid d-block rounded-circle w-75" src="../../Downloads/blank-profile-picture-973460_960_720.png"></div>
